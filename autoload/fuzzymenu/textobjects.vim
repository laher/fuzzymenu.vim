...
function! fuzzymenu#textobjects#AddRoot() abort
  call fuzzymenu#Add('Operations', {
        \ 'exec': 'call fuzzymenu#textobjects#OperatorsRoot()',
        \ 'after': 'call fuzzymenu#InsertModeIfNvim()', 
        \ 'tags': ['normal','fzf']
        \})
endfunction

function! fuzzymenu#textobjects#OperatorsRoot() abort
 let opts = {
  ...
  \ }
  call fzf#run(fzf#wrap('fzm#textobjects#OperatorsRoot', opts, 0))
endfunction
...
function! fuzzymenu#textobjects#AddOperations() abort
  let ops = {}
